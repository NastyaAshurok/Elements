...
public class TestElements {
    ...
    public void dropdownSelectionByOption(){
       ...
       // dropdownPage.dropdownSelection("Option 2");
        String input = dropdownPage.dropdownSelection("Option 2");
       Assert.assertEquals(input,"Option 2", "Option is Not selected"); //???
    }
    ...
    public void downloadTxtFile(String filename) throws FileNotFoundException {
       ...
       String fileName = "some-file.txt";
        ...
        Assert.assertEquals(downloadFilePage.downloadFile(fileName),fileName, "isn't found on page"); //???
    }
